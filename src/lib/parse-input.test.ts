...
describe("parseRepoInput", () => {
  ...
  it("accepts github.com URL", () =>
    ok("github.com/redis/redis", "redis", "redis"))
  ...
  it("accepts www prefix", () =>
    ok("www.github.com/redis/redis", "redis", "redis"))
  it("accepts hyphenated names", () =>
    ok("vercel/next.js", "vercel", "next.js"))
  it("accepts numeric names", () =>
    ok("user123/repo456", "user123", "repo456"))
  it("accepts dashes in repo", () =>
    ok("godotengine/godot-builds", "godotengine", "godot-builds"))
